...
Route::middleware('auth:sanctum', 'verified')->group(function() {
  ...
  Route::view('/expert/profile/{any?}', 'web.pages.user.expert.index')->name('page.expert.profile')->middleware(['role:expert']);

  // Student
  // Route::get('/student/{any?}', [StudentController::class, 'index'])->name('page.student.profile')->where('any', '.*')->middleware(['role:student']);
  Route::view('/student/profile/{any?}', 'web.pages.user.student.index')->name('page.student.profile')->middleware(['role:student']);
