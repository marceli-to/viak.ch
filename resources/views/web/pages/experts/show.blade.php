  ...
  <article class="content-text-media">
    <figure class="text-media__visual">
      @if ($expert->visualImage)
        <x-image :maxSizes="[0 => 700, 700 => 1100, 1000 => 1600]" width="600" height="600" :image="$expert->visualImage" ratio="16x9" :caption="$expert->fullname" />
      @else
        <img src="/media/viak-placeholder-visual.png" width="1600" height="1000" alt="{{ $expert->fullname }}">
      @endif
    </figure>
