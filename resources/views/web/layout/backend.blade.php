<!doctype html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="is-auth is-dashboard">
<head>
<meta charset="utf-8">
...
<meta property="og:image" content="@if(trim($__env->yieldContent('og_image')))@yield('og_image')@else{{ asset('assets/img/forum-architektur-og.jpg') }}@endif">
