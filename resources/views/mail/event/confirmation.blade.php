...
<p class="py-2x"><a href="{{ route('page.student.profile') }}" target="_blank" class="button button-primary" style="text-decoration: none;"><strong>{{ __('Mit Kreditkarte bezahlen') }}</strong></a></p>
