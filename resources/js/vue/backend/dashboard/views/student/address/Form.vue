...
<form @submit.prevent="submit" v-if="isFetched">
  <article-text>
    <template #aside>
      ...
      <back-link :route="'student-edit'"></back-link>
    </template>
    <template #content>
...
export default {
  ...
  data() {
    return {
      ...
      // Routes
      routes: {
        find: '/api/dashboard/student/address',
        store: '/api/dashboard/student/address',
        update: '/api/dashboard/student/address',
        delete: '/api/dashboard/student/address',
  ...
  methods: {
    ...
    store() {
      ...
      this.axios.post(this.routes.store, this.data).then(response => {
        this.$router.push({ name: 'student-edit', params: { id: this.$route.params.id }});
      })
      .catch(error => {
