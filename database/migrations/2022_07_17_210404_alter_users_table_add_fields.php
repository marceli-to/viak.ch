...
class AlterUsersTableAddFields extends Migration
{
    ...
    public function up()
    {
      Schema::table('users', function (Blueprint $table) {
        ...
        $table->string('zip', 10)->nullable()->after('street_no');
        $table->string('city', 255)->nullable()->after('zip');
        $table->string('phone', 15)->nullable()->after('city');
        $table->tinyInteger('has_alt_invoice_address')->default(0)->after('phone');
        $table->text('invoice_address')->nullable()->after('has_alt_invoice_address');
    ...
    public function down()
    {
      Schema::table('users', function (Blueprint $table) {
        ...
        $table->dropColumn('has_alt_invoice_address');
